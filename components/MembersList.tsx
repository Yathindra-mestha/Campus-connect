        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {!loading && filteredMembers.length === 0 && (
                <div className="text-center py-24 bg-slate-50 dark:bg-white/5 rounded-3xl border-2 border-dashed border-slate-200 dark:border-white/10">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white">No user is available</h3>
                    <p className="text-slate-500 dark:text-slate-400">Try adjusting your search terms or branch filters.</p>
                </div>
            )}
        </div>
    );
