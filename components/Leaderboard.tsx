...
import { Trophy, Medal, Star, Search, Filter, ChevronUp, ChevronDown, Loader2, User } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          {filteredUsers.length === 0 ? (
            <div className="text-center py-16 px-4">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">No user is available</h3>
              <p className="text-slate-500 dark:text-slate-400 mb-6 max-w-sm mx-auto">
                Try adjusting your search terms or branch filters to find who you're looking for.
              </p>
              <button
                onClick={() => {
                  setSearchQuery('');
                ...
                className="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold text-sm transition-colors shadow-sm"
              >
                Clear Search
              </button>
            </div>
